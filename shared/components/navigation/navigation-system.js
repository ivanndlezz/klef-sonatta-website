    ...
    function initNavigationListeners() {
        ...
        document.addEventListener('mousemove', (e) => {
            if (window.innerWidth > 768) {
                ...
                const overMega = Array.from(document.querySelectorAll('.mega-menu')).some(menu => menu.contains(e.target));
        ...
        document.body.addEventListener('click', (e) => {
            if (e.target === document.body && navbar && navbar.classList.contains('mobile-open')) {
                closeMenu();
            }
        });
