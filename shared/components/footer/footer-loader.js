/**
 * footer-loader.js
 * Carga dinámica del footer de Klef Agency
 */
  ...
  <div class="footer-container">
    ...
    <div class="footer-col" data-column="4">
      ...
      <ul class="footer-links">
        ...
        <li>
          <a href="https://www.facebook.com/klef.agency/" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en Facebook" class="social-link">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
          <a href="https://www.youtube.com/channel/UCYFT6kwbsDzbiK6OjuKWM5w" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en YouTube" class="social-link">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <li>
          <a href="https://wa.me/526245161037" target="_blank" rel="noopener noreferrer" aria-label="Contactarnos por WhatsApp" class="social-link">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
